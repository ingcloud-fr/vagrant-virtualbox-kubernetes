...
kubectl delete -f manifests/app-a.yaml --ignore-not-found > /dev/null
kubectl delete -f manifests/app-b.yaml --ignore-not-found > /dev/null
kubectl delete -f manifests/app-c.yaml --ignore-not-found > /dev/null
