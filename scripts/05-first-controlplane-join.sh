...
# INIT
echo "⚙️  Pull images for kudeadm ..."
kubeadm config images pull
echo "⚙️  Cluster initialization with kubeadm init --control-plane-endpoint $ADVERTISE_IP:6443 ... "
...
echo "🏁 Primary CONTROLPLANE node $(hostname) successfully joined the Kubernetes cluster !"